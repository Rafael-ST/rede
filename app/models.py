...
class LiderDeEquipe(BaseModel):
    ...
    cargo = models.CharField(verbose_name='Se sim, qual cargo?', max_length=50, null=True)
    ano = models.CharField(verbose_name='Ano de candidatura', max_length=10, null=True)
    votos = models.IntegerField(verbose_name='Quantidade de votos', null=True)
